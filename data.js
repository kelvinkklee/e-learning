...
const I18N = {
  zh: {
    ...
    aiNote:"⚠️ API Key 只會儲存喺你本機（localStorage），唔會上傳。請勿喺公共電腦使用個人 Key。",
  ...
  en: {
    ...
    aiNote:"⚠️ Your API Key is stored locally (localStorage) only. Do not use a personal key on a shared computer.",
